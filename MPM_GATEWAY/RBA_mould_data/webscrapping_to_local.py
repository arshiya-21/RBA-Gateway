...
from mpmgateway.core.webscrap_gateway_v3 import Scrapper
import json
...
x = Scrapper(config,mould_config,etl_config = "/home/manoj/Desktop/MPM_GATEWAY/RBA_mould_data/process_dig_mould_data.py")
x.scrapper_to_local()
